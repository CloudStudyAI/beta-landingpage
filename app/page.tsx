    ...
    <main className="page-shell min-h-screen overflow-x-clip bg-white text-[var(--color-text)]">
      ...
      <div className="relative isolate overflow-x-clip bg-white">
        <svg
          ...
          className="pointer-events-none absolute -left-10 top-8 z-0 hidden h-[30%] w-20 fill-[#1877f2] sm:block md:-left-8 md:h-[32%] md:w-24 lg:-left-10 lg:top-10 lg:h-[38%] lg:w-32 xl:-left-2 xl:h-[42%] xl:w-36"
        >
