...
export function LaunchHero() {
  return (
    <section id="top" aria-labelledby="launch-hero-title" className="relative isolate overflow-hidden bg-[#f5f9ff] px-5 pb-16 pt-10 sm:px-8 sm:pb-20 sm:pt-14 lg:pb-24 lg:pt-16">
      <div aria-hidden="true" className="absolute left-1/2 top-20 -z-10 h-[34rem] w-[34rem] -translate-x-1/2 rounded-full bg-blue-200/35 blur-3xl lg:left-[78%]" />
