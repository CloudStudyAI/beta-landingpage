...
export const LEGAL_URLS = {
  ...
  privacy: `${LEGAL_BASE_URL}/privacidade`,
  refundPolicy: `${LEGAL_BASE_URL}/cancelamento-e-reembolso`,
} as const;
...
export const LEGAL_OPERATOR = {
  ...
  supportEmail: "contato@cloudstudy.com.br",
  privacyEmail: "contato@cloudstudy.com.br",
} as const;
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "contratação: plano, preço, moeda, periodicidade, status de assinatura ou compra, identificadores Stripe e Mercado Pago e eventos financeiros necessários à reconciliação;",
...
export const REFUND_DOCUMENT: LegalDocument = {
  ...
  sections: [
    ...
    {
      title: "3. Compra anual pré-paga",
      paragraphs: [
        "O plano anual vigente é uma compra única pré-paga. O valor total anual indicado no resumo é cobrado na contratação, o acesso vale pelo período informado na oferta e não existe renovação automática ao final. O equivalente mensal exibido é apenas referência de comparação.",
      ],
    },
    {
